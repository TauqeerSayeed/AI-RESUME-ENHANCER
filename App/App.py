...
def run():
    ...
    activities = ["User", "Feedback", "About", "Admin","Template"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built with 🤍 by <a href="https://github.com/TauqeerSayeed" style="text-decoration: none; color: #021659;">Tauqeer Sayeed</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://github.com/TauqeerSayeed" style="text-decoration: none; color: grey;">Tauqeer Sayeed</a> through  
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@123':
                ...
                st.success("Welcome Tauqeer! Total %d " % values + " User's Have Used Our Tool : )")                
